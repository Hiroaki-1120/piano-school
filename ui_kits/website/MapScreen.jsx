...
function MapScreen({ initialArea, onOpenStudio, onListView }) {
  ...
  return (
    <div style={{ maxWidth: "var(--container-max)", margin: "0 auto", padding: "var(--space-8) var(--space-6) 0" }}>
      ...
      <div className="op-map-grid" style={{ display: "grid", gridTemplateColumns: "360px 1fr", gap: "var(--space-5)", alignItems: "start" }}>
        {/* List column */}
        <div className="op-map-list" style={{ display: "flex", flexDirection: "column", gap: "var(--space-4)", maxHeight: 560, overflow: "auto", paddingRight: 4 }}>
          {results.map((s) => (
        ...
        {/* Map column */}
        <div className="op-map-canvas" style={{ position: "sticky", top: 88, height: 560, borderRadius: "var(--radius-xl)", overflow: "hidden", border: "1px solid var(--hairline-strong)", boxShadow: "var(--shadow-sm)", ...mapBg }}>
          {/* placeholder note */}
