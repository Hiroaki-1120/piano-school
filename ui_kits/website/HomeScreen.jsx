  ...
  return (
    <div>
      ...
      <section style={{ position: "relative", overflow: "hidden", background: "linear-gradient(160deg, var(--clay-50) 0%, var(--cream) 60%)" }}>
        <div className="op-hero-grid" style={{ maxWidth: "var(--container-max)", margin: "0 auto", padding: "var(--space-20) var(--space-6)", display: "grid", gridTemplateColumns: "1.05fr 0.95fr", gap: "var(--space-12)", alignItems: "center" }}>
          <div>
          ...
          {/* Hero image */}
          <div className="op-photo-ph op-hero-photo" style={{ height: 380, borderRadius: "var(--radius-2xl)", boxShadow: "var(--shadow-lg)" }}></div>
        </div>
      </section>

      {/* How it works */}
      <section style={{ maxWidth: "var(--container-max)", margin: "0 auto", padding: "var(--space-16) var(--space-6) 0" }}>
        <div className="op-grid-3" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "var(--space-6)" }}>
          {[
