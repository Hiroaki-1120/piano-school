...
function ListingScreen({ initialArea, onOpenStudio, onMapView }) {
  ...
  return (
    <div style={{ maxWidth: "var(--container-max)", margin: "0 auto", padding: "var(--space-10) var(--space-6) 0" }}>
      ...
      <div className="op-listing-grid" style={{ display: "grid", gridTemplateColumns: "260px 1fr", gap: "var(--space-8)", alignItems: "start" }}>
        {/* Filters */}
        <aside className="op-listing-aside" style={{ position: "sticky", top: 88, background: "var(--ivory)", border: "1px solid var(--hairline)", borderRadius: "var(--radius-lg)", padding: "var(--space-5)", boxShadow: "var(--shadow-xs)" }}>
